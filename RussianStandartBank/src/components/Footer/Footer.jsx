          ...
          <div className={classes.column}>
            <div className={classes.phoneBlock}>
              <div className={classes.phoneNumber}>
                <a href="tel:84957480748">8 495 748-0-748</a>
              </div>
            ...
            <div className={classes.appBlock}>
              <a
                href="https://www.rsb.ru/remote/mobile/"
              ...
              <div>
                <div className={classes.appHref}>
                  <a href="https://www.rsb.ru/remote/mobile/">
                    Мобильный банк
                    <br />
                    Русский Стандарт Онлайн
                  </a>
                </div>
            ...
            <p className={classes.legalText} style={{ fontSize: 14 }}>
              АО «Банк Русский Стандарт» для повышения удобства работы с
              веб-сайтом rsb.ru (далее — Сайт) и с целью персонализации сервисов
              использует файлы «cookie» (небольшие файлы, содержащие информацию
              о предыдущих посещениях веб-сайтов). Продолжая пользоваться
              Сайтом, Вы выражаете своё согласие на обработку данных
              пользователя Сайта. В случае несогласия с обработкой Ваших
              пользовательских данных Вы можете отключить сохранение файлов
              «cookie» в настройках Вашего браузера. В этом случае работа
              некоторых сервисов на Сайте может быть ограничена.
            </p>
            ...
            <div className={classes.insuranceBlock}>
              ...
              <span>
                Вклады в Банке Русский Стандарт застрахованы в соответствии с
